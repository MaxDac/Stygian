...
MapHelpers.add_map(%{parent_id: east_end_id, name: "Auld Chapel", coords_type: "poly", coords: "375,264,426,228,478,217,510,218,584,262,562,314,479,353,435,307"})
MapHelpers.add_map(%{parent_id: east_end_id, name: "Abandoned Hotel", coords_type: "poly", coords: "131,365,176,327,220,318,289,321,363,327,343,369,290,410,184,409,178,410,147,385"})

MapHelpers.add_map(%{parent_id: fields_id, name: "Outer Fields", coords_type: "poly", coords: "237,221,315,198,344,198,334,236,328,253,312,259,221,260"})
MapHelpers.add_map(%{parent_id: fields_id, name: "Refuge", coords_type: "poly", coords: "434,328,529,295,571,332,575,348,560,359,499,406,435,411,424,360"})

MapHelpers.add_map(%{parent_id: french_hill_id, name: "City Market", coords_type: "poly", coords: "156,330,203,335,222,345,243,351,258,371,263,386,259,404,92,416,95,407,117,372,140,343,146,335"})
MapHelpers.add_map(%{parent_id: french_hill_id, name: "Georgian Apartments", coords_type: "poly", coords: "362,203,464,207,505,216,516,227,582,241,596,252,592,272,397,327,375,284,339,265,336,234,338,217,346,209"})

MapHelpers.add_map(%{parent_id: old_eel_id, name: "Old Eel Hotel", coords_type: "poly", coords: "357,190,382,190,457,194,444,234,422,269,404,282,305,278,278,233,280,218,288,208,301,203"})
MapHelpers.add_map(%{parent_id: old_eel_id, name: "Overran Apartments", coords_type: "poly", coords: "521,478,532,482,592,507,605,519,596,539,417,571,398,530,378,489,380,474,387,464,395,459,409,455"})

MapHelpers.add_map(%{parent_id: university_id, name: "Miskatonic University", coords_type: "poly", coords: "328,302,431,289,509,308,522,317,527,328,560,358,527,411,511,407,373,377,298,345"})

MapHelpers.add_map(%{parent_id: wastes_id, name: "Port", coords_type: "poly", coords: "444,248,471,249,524,260,525,275,519,287,506,292,433,288,438,269"})
MapHelpers.add_map(%{parent_id: wastes_id, name: "Paper Factory", coords_type: "poly", coords: "113,129,143,130,178,145,215,155,299,199,256,255,241,251,125,213,104,165"})
