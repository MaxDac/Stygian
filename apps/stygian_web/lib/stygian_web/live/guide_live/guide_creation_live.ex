  ...
  def creation(assigns) do
    ...
    <.guide_p>
      ...
      <ul>
        ...
        <li class="font-normal text-md">
          <b>Mente</b>: è l’intelligenza e la saggezza del personaggio, la sua capacità di studio, di ragionamento e di interpretazione del mondo e dei fenomeni soprannaturali comuni ad Arkham. 
        </li>
        <li class="font-normal text-md">
    ...
    <.guide_p>
      ...
      <ul>
        ...
        <li class="font-normal text-md">
          <b>Scienza</b>: rappresenta la conoscenza del personaggio delle scienze naturali, come la biologia, la chimica, la fisica, e la medicina. Questa abilità aiuterà il personaggio a sviluppare e disegnare nuove tecnologie e dispositivi, che potranno essere creati per facilitargli la vita ad Arkham.
        </li>
        <li class="font-normal text-md">
