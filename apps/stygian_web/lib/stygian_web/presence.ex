defmodule StygianWeb.Presence do
  ...
  """
  def track_user(pid, user, character, map \\ nil) do
  ...
  defp map_map(%{id: map_id, name: map_name}), do: %{id: map_id, name: map_name}
  defp map_map(_), do: %{id: nil, name: "Mappa principale"}
